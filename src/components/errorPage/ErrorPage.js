...
const ErrorPage = () => {
    return (
        <div className='flex flex-col mt-8 justify-center items-center w-1/2 m-auto'>
            ...
            <p className='text-lg'>We are very sorry for the inconvenience. It looks like you're trying to access a page that has been deleted or never even existed.</p>
